...
class Postprocessor(object):
  ...
  """
    ...
    """
        ...
        assert self._pca_matrix.shape == (vggish_params.EMBEDDING_SIZE,
                                          vggish_params.EMBEDDING_SIZE), (
                                              'Bad PCA matrix shape: %r' %
                                              (self._pca_matrix.shape, ))
        assert self._pca_means.shape == (vggish_params.EMBEDDING_SIZE,
                                         1), ('Bad PCA means shape: %r' %
    ...
    """
        assert len(
            embeddings_batch.shape) == 2, ('Expected 2-d batch, got %r' %
        ...
        clipped_embeddings = np.clip(pca_applied,
