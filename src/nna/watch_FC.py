...
if __name__ == "__main__":
  ...
  device = torch.device(
      "cuda:" + GPU_INDEX if torch.cuda.is_available() else "cpu")

  classifier = FC_embed(
      device=device, classifier_model_path="assets/mlp_models/bird_FC_089valid_20191122-131739.pth")
    ...
    if files_to_do:
      ...
      for vgg_npy_file in files_to_do:
        ...
        pre_process_func.save_to_csv(
            Audioset_output_queue, [[str(vgg_npy_file)]])
