...
class vggish_model:
    ...
    def __init__(self, embedding_checkpoint="assets/vggish_model.ckpt", pca_params= "assets/vggish_pca_params.npz",
        ...
        # Metadata
        self.labels = self.load_labels('assets/class_labels_indices.csv')
    ...
    def generate_embeddings(self, sound,batch_size=256):
        ...
        Input args:
            sound   = numpy array with samples from wavfile_to_examples
        Returns:
