...
#   print("dividing into 1 hour segments")
  ...
  mp3_segments.sort()
  transformed_dataset = NatureDataset(mp3_file_path=mp3_file_path,
                                    segments_folder=segments_folder,
                                    mp3_segments=mp3_segments,
  ...
  for i_batch, sample_batched in enumerate(dataloader):
    # print(i_batch, sample_batched['wav_data'].size(),
    #       sample_batched['sr'].size())atom://teletype/portal/2b996be5-aaee-4b86-8294-d45666bcf915
    sounds.extend(sample_batched['wav_data'])
#   print("pre_process")
  print("pre_process")
  sys.stdout.flush()
